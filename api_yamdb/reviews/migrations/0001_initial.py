# Generated by Django 2.2.16 on 2022-05-04 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=100, null=True, verbose_name='Описание произведения')),
                ...
                ('genre', models.ManyToManyField(related_name='titles', through='reviews.Genre_title', to='reviews.Genre', verbose_name='Жанр произведения')),
            ],
            options={
